...
const SurveyQuestion:React.FC<SurveyQuestionProps> =({question, index, total, user, children}) => {
    ...
    return(
        <div className="mb-6">
            ...
            <p className="text-2xl">{lang === "en" ? user?.display_name_en : user?.display_name_ka} {lang==="en" ? question.title_en : question.title_ka}</p>
            </div>
            {children}
            </div>
