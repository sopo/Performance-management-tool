...
const FilledCardContent: React.FC<FilledCardContentProps> = ({
  peerNumber,
}) => {
  ...
  return (
    <>
      <p className="border-t border-border pt-4 text-foreground text-md">
        {t("pages.evaluateEmployees.filledState.youHaveToEvaluate")}{" "}
        {peerNumber} {t("pages.evaluateEmployees.filledState.peers")}
      </p>
      <div className="flex flex-col gap-2 border-b border-border pb-4 "></div>
      <div className="flex flex-col gap-2 border-b border-border pb-4 ">
        <p className="text-muted-foreground text-sm">
          {t("pages.evaluateEmployees.filledState.evaluateUntilDeadline")}
        </p>
